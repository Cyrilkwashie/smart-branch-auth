...
const AmendAccountMsg: React.FC = () => {
  ...
  const handleSearch = () => {
    ...
    const filteredMessages = allMessages.filter(message =>
      message.accountNo.includes(searchAccountNumber)
    );
            ...
            <div className="max-w-7xl mx-auto space-y-6">
              <Card className="border shadow-sm">
                <CardHeader className="bg-muted/30">
                  <CardTitle className="text-base">Amend Account Message</CardTitle>
                </CardHeader>
...
export default AmendAccountMsg;