                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="mt-2 text-sm text-red-700">
                            <p>Removing a relationship may affect account operations and legal standing. Ensure all necessary approvals and documentation are in place before proceeding.</p>
                          </div>
                        </div>
                      </div>
                    </div>
