...
const AmendAdditionalAccount = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Amending additional account...");
  };
          ...
          <main className="p-6">
            <div className="max-w-7xl mx-auto space-y-6">
              <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold tracking-tight">Amend Additional Account</h1>
              </div>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex gap-4">
                    <div className="flex-1">
                      <Label htmlFor="accountNumber">Additional Account Number</Label>
                      <Input
                        id="accountNumber"
              ...
              {accountData && (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Card className="border-0 shadow-md">
                    <CardHeader className="border-b">
                      <CardTitle className="text-lg">Update Account Details</CardTitle>
                    </CardHeader>
                    <CardContent className="p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="accountType">Account Type *</Label>
                          <Select defaultValue={accountData.accountType}>
...
export default AmendAdditionalAccount;
