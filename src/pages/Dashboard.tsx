                        ...
                        <div className="relative -mt-12 mb-4">
                          <div className="relative inline-block">
                            <Avatar className="h-24 w-24 border-4 border-background shadow-xl">
                              ...
                              <AvatarFallback className="text-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white">JD</AvatarFallback>
                            </Avatar>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3 text-sm">
                              ...
                              <div>
                                ...
                                <p className="font-medium text-xs">john.doe@smartbranch.com</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <Card className="border-0 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
                      <CardContent className="p-6">
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <p className="text-sm font-medium text-muted-foreground">Daily Target Achievement</p>
                            <p className="text-2xl font-bold">80%</p>
                          </div>
                          <div className="space-y-2">
                            <Progress value={80} className="h-3" />
                            <p className="text-xs text-muted-foreground">4 of 5 goals completed today</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <CardContent className="p-6">
                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        <div className="space-y-3">
                          ...
                          <p className="text-xs text-green-600">+5.2% vs target</p>
                        </div>
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                          ...
                          <p className="text-xs text-green-600">+8.5% vs target</p>
                        </div>
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                          ...
                          <p className="text-xs text-green-600">Within limits</p>
                        </div>
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                          ...
                          <p className="text-xs text-muted-foreground">60% of target</p>
                        </div>
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                ...
                <Card className="border-0 shadow-md">
                  <CardHeader className="border-b bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20">
                    <CardTitle className="text-lg flex items-center gap-2">
                      ...
                      Alerts & Notifications
                      <Badge className="ml-auto bg-red-500 hover:bg-red-600">4 New</Badge>
                    </CardTitle>
                  </CardHeader>
                    ...
                    <div className="space-y-3">
                      <div className="group flex items-start gap-3 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-blue-50/50 dark:from-blue-950/30 dark:to-blue-950/10 border border-blue-200 dark:border-blue-900 hover:shadow-md transition-all cursor-pointer">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-sm mb-1">Follow-up Required</p>
                      ...
                      <div className="group flex items-start gap-3 p-4 rounded-xl bg-gradient-to-r from-orange-50 to-orange-50/50 dark:from-orange-950/30 dark:to-orange-950/10 border border-orange-200 dark:border-orange-900 hover:shadow-md transition-all cursor-pointer">
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                          <AlertCircle className="h-5 w-5 text-white" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-sm mb-1">KYC Update Pending</p>
                      ...
                      <div className="group flex items-start gap-3 p-4 rounded-xl bg-gradient-to-r from-red-50 to-red-50/50 dark:from-red-950/30 dark:to-red-950/10 border border-red-200 dark:border-red-900 hover:shadow-md transition-all cursor-pointer">
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                          <Clock className="h-5 w-5 text-white" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-sm mb-1">Loan Renewal Due</p>
                      ...
                      <div className="group flex items-start gap-3 p-4 rounded-xl bg-gradient-to-r from-green-50 to-green-50/50 dark:from-green-950/30 dark:to-green-950/10 border border-green-200 dark:border-green-900 hover:shadow-md transition-all cursor-pointer">
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                          <Cake className="h-5 w-5 text-white" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-sm mb-1">Customer Birthday</p>
                      ...
                      <div className="relative">
                        <div className="flex gap-4">
                          <div className="flex flex-col items-center">
                            ...
                            <div className="text-xs text-muted-foreground mt-2 font-medium">2:00 PM</div>
                          </div>
                          <div className="flex-1 p-4 rounded-xl bg-gradient-to-r from-primary/10 to-primary/5 border-2 border-primary/30 shadow-sm hover:shadow-md transition-all">
                            <div className="flex items-start justify-between mb-2">
                              <p className="font-semibold">Meeting with SME Client</p>
                              <Badge className="bg-red-500 hover:bg-red-600 text-white shadow-sm">High</Badge>
                            </div>
                            <p className="text-sm text-muted-foreground mb-3">Discuss new loan application - $750K</p>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <div className="group flex items-center gap-3 p-3 rounded-lg hover:bg-muted transition-all cursor-pointer border border-transparent hover:border-primary/20">
                            ...
                            <div className="flex-1">
                              <p className="text-sm font-medium">Review 2 loan approvals</p>
                            </div>
                            <Badge variant="outline" className="text-xs bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800">Today</Badge>
                          </div>
                          <div className="group flex items-center gap-3 p-3 rounded-lg hover:bg-muted transition-all cursor-pointer border border-transparent hover:border-primary/20">
                            <div className="h-5 w-5 rounded border-2 border-primary group-hover:bg-primary/10 transition-colors"></div>
                            <div className="flex-1">
                              <p className="text-sm font-medium">Customer site visit - XYZ Ltd</p>
                            </div>
                            <Badge variant="outline" className="text-xs bg-orange-50 dark:bg-orange-950 text-orange-700 dark:text-orange-300 border-orange-200 dark:border-orange-800">Tomorrow</Badge>
                          </div>
                          <div className="group flex items-center gap-3 p-3 rounded-lg hover:bg-muted transition-all cursor-pointer border border-transparent hover:border-primary/20">
                            <div className="h-5 w-5 rounded border-2 border-primary group-hover:bg-primary/10 transition-colors"></div>
                            <div className="flex-1">
                              <p className="text-sm font-medium">Quarterly report submission</p>
                            </div>
                            <Badge variant="outline" className="text-xs bg-purple-50 dark:bg-purple-950 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-800">This Week</Badge>
                          </div>
                        </div>
                      </div>
                    </div>
