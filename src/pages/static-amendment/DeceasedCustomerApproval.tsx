            ...
            <div className="max-w-4xl mx-auto">
              <Card className="border shadow-sm">
                <CardHeader className="bg-muted/30">
                  <CardTitle className="text-base">Deceased Customer Approval</CardTitle>
                </CardHeader>
                <CardContent className="p-6">
                  <p className="text-gray-600">Deceased Customer Approval functionality will be implemented here.</p>
                </CardContent>
              </Card>
            </div>
          </main>
