            ...
            <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6 animate-fade-in">
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="pt-0">
                  <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-lg border border-blue-200/50 dark:border-blue-800/50">
                    <Building2 className="h-8 w-8 text-blue-600 dark:text-blue-400" />
                    <div>
                      <p className="font-medium text-blue-900 dark:text-blue-100">{selectedCategory}</p>
                      <p className="text-sm text-blue-700 dark:text-blue-300">{relationshipInfo.description}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription className="text-xs text-muted-foreground">{relationshipInfo.description}</FormDescription>
                              </FormItem>
                            )}
                          />
